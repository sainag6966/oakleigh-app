...
function BasketDrawer({
  ...
  return (
    ...
    >
      <div className="fixed right-0 top-0 z-[2] flex h-screen w-auto max-w-[360px] flex-col items-start overflow-y-scroll bg-textPrimary text-footerBg sm:max-w-[480px] lg:max-w-[817px]">
