...
function InsightBlock({ trayData }) {
  ...
  return (
    <div className="dxl:px-[140px] flex h-auto w-full flex-col justify-between gap-6 px-9 pt-[60px] lg:px-20 lg:pt-[120px]">
        ...
        {data.map((e, index) => {
          return (
            <div key={index} className="flex flex-col w-full h-auto justify-center items-center lg:items-start text-center lg:text-start">
              <div className="relative w-full flex flex-col justify-between items-center h-[356px] dxl:h-[526px]">
                <Image
                  src={e.url}
                  layout="fill"
                  alt="AdBlock"
