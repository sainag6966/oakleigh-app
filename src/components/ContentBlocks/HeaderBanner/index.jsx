...
function HeaderBanner({ trayData }) {
  ...
  return (
    <div className="relative h-[578px] w-full lg:h-[520px]">
      ...
      />
      <div className="absolute top-[80px] flex w-full flex-col gap-9 px-9 text-display-13 text-textPrimary md:px-16 lg:top-[196px] xl:min-w-[1000px] xl:max-w-[740px] xl:px-[100px] dxl:max-w-[1000px] dxl:gap-10 dxl:px-[144px] dxl:text-display-15">
