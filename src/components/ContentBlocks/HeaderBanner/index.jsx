...
function HeaderBanner({ trayData }) {
  ...
  return (
    <div className="relative h-[578px] w-full lg:h-[520px]">
      ...
      />
      <div className="absolute top-[60px] flex w-full flex-col gap-6 px-9 text-display-13 text-textPrimary md:top-[196px] md:px-16 xl:min-w-[1000px] xl:max-w-[740px] xl:px-[100px] dxl:max-w-[1000px] dxl:gap-10 dxl:px-[144px] dxl:text-display-15">
